...
l1 = (
    d1.replace("/mnt/seaes01-data01/dmg/dmg/mbessdl2/Spanish_Plume/WRF/", "")
    .replace("run-zrek/", "Control")
    .replace("run-zrek.", "")
    .replace("/", "")
)
l2 = (
    d2.replace("/mnt/seaes01-data01/dmg/dmg/mbessdl2/Spanish_Plume/WRF/", "")
    .replace("run-zrek/", "Control")
    .replace("run-zrek.", "")
    .replace("/", "")
)
