...
These instructions are for installing a new version of the tool on our shared service. Notes:
- Replace `<version>` with your new version number (e.g. `2.2.1`) in the commands below.
